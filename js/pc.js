(function() {
  ...
  pc = {
    ...
    andoropov: {
      ...
      config: {
        "OS": ["<s>Windows XP Home Edition SP2</s>", "Windows Server 2003 R2 Enterprise Edition(評価版)"],
        "CPU": "Athlon64 3000+",
        "メモリ": "1GB",
        "HDD": "120GB+32GB(Khrushchevからの移植)",
        "モニタ": "17inch",
        "ドライブ": ["スーパーコンボドライブx1", "FDDx1"],
    ...
    nebuchadnezzarii: {
      ...
      config: {
        "OS": ["Windows XP Professional SP2", "Fedora7, VineLinux4.1"],
    ...
    tiglathPileser: {
      ...
      config: {
        "OS": ["Windows XP <s>Professional</s> Home Edition", "<s>Ubuntu Linux</s>"],
        "CPU": "AthlonXP 1800+",
        "メモリ": "1GB",
        "HDD": "160GB",
        "モニタ": "15inch",
